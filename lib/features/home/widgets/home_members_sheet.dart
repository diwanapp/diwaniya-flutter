...
class HomeMembersSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = context.cl;
    bool isManagerLike(DiwaniyaMember m) =>
        m.role == 'manager' || m.role == 'founder' || m.role == 'billing_owner';

    int roleRank(DiwaniyaMember m) {
      if (m.role == 'founder') return 0;
      if (isManagerLike(m)) return 1;
      return 2;
    }

    final sorted = List<DiwaniyaMember>.from(members)
      ..sort((a, b) => roleRank(a).compareTo(roleRank(b)));
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Row(children: [
          Expanded(
            ...
            Text(Ar.membersTitle,
                style: TextStyle(
                    fontSize: 18, fontWeight: FontWeight.w700, color: c.t1)),
            const SizedBox(height: 4),
            Text('${members.length} ${Ar.memberUnit}',
            ...
            return Container(
              ...
              child: Row(children: [
                ...
                Container(
                    ...
                    child: Text(
                        isFounder ? 'المؤسس' : (isMgr ? Ar.manager : Ar.member),
                        style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.w600,
